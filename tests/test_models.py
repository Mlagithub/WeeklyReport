...
class TestUserPermissions:
    ...
    def test_all_permissions_returns_list(self, client):
        ...
        with client.application.app_context():
            ...
            user = user_datastore.create_user(
                email="lead@example.com", username="leaduser", password=hash_password("LeadPass123"), roles=[role]
            )
            db.session.commit()
    ...
    def test_all_permissions_caches_result(self, client):
        ...
        with client.application.app_context():
            ...
            user = user_datastore.create_user(
                email="emp2@example.com", username="emp2user", password=hash_password("EmpPass123"), roles=[role]
            )
            db.session.commit()
    ...
    def test_can_view_group_with_view_all_permission(self, client):
        ...
        client.post("/login", data={"username": "admin2user", "password": "AdminPass123"})
    ...
    def test_can_view_group_with_view_group_permission(self, client):
        ...
        # Login as the user
        client.post("/login", data={"username": "leaderuser", "password": "LeaderPass123"})
    ...
    def test_can_view_group_without_permission(self, client):
        ...
        # Login as the user
        client.post("/login", data={"username": "basicuser", "password": "BasicPass123"})
    ...
    def test_managed_group_view_all(self, client):
        ...
        client.post("/login", data={"username": "admin3user", "password": "AdminPass123"})
    ...
    def test_managed_group_view_group(self, client):
        ...
        # Login to set current_user for can_view_group
        client.post("/login", data={"username": "leader2user", "password": "LeaderPass123"})
...
class TestAuthorizationFunctions:
    ...
    def test_can_edit_record_owner(self, client):
        ...
        with client.application.app_context():
            ...
            user = user_datastore.create_user(
                email="owner@example.com", username="owneruser", password=hash_password("OwnerPass123"), roles=[role]
            )
            db.session.commit()
    ...
    def test_can_edit_record_non_owner(self, client):
        ...
        with client.application.app_context():
            ...
            user_a = user_datastore.create_user(
                email="usera@example.com", username="usera", password=hash_password("Pass123"), roles=[role]
            )

            user_b = user_datastore.create_user(
                email="userb@example.com", username="userb", password=hash_password("Pass123"), roles=[role]
            )
            db.session.commit()
    ...
    def test_get_allowed_usernames_view_all(self, client):
        ...
        with client.application.app_context():
            ...
            for i in range(3):
                user_datastore.create_user(
                    email=f"user{i}@example.com", username=f"user{i}", password=hash_password("Pass123"), roles=[role]
                )
            db.session.commit()
    ...
    def test_get_allowed_usernames_view_group(self, client):
        ...
        client.post("/login", data={"username": "leader3user", "password": "LeaderPass123"})
    ...
    def test_get_allowed_usernames_self_only(self, client):
        ...
        with client.application.app_context():
            ...
            user = user_datastore.create_user(
                email="selfonly@example.com", username="selfonlyuser", password=hash_password("Pass123"), roles=[role]
            )
    ...
    def test_get_allowed_groups_view_all(self, client):
        ...
        client.post("/login", data={"username": "admin6user", "password": "AdminPass123"})
    ...
    def test_get_allowed_groups_view_group(self, client):
        ...
        # Login for managed_group
        client.post("/login", data={"username": "leader4user", "password": "LeaderPass123"})
    ...
    def test_get_allowed_groups_none(self, client):
        ...
        with client.application.app_context():
            ...
            user = user_datastore.create_user(
                email="noperms@example.com", username="nopermsuser", password=hash_password("Pass123"), roles=[role]
            )
