...
Plans:
- [x] 15-00-PLAN.md — Wave 0: Test infrastructure for AI API calls
- [x] 15-01-PLAN.md — Wave 1: Core API call function with error handling, timeout, audit logging (API-01, API-02, API-03, SEC-02)
- [x] 15-02-PLAN.md — Wave 2: Response processing utilities (API-04)
...
- [x] 16-02-PLAN.md — Wave 2: Admin CRUD route + UI + default templates (TEMPLATE-01, TEMPLATE-03)
...
- [x] 17-01-PLAN.md — Wave 1: SummaryGenerationForm + summary_utils.py (SUMMARY-01, SUMMARY-02, SUMMARY-03, SUMMARY-04)
- [x] 17-02-PLAN.md — Wave 2: Route + UI + JavaScript interactions (SUMMARY-01, SUMMARY-02, SUMMARY-03, SUMMARY-04, UI-01, UI-02)
